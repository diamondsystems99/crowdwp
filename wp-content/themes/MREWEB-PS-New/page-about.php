            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <div class="box-img item1 ani5">
                        <img alt="" src="<?php echo $_DIR; ?>images/banner/item1.jpg" />
                    </div>
                    <div class="box-img item2 ani4">
                        <img alt="" src="<?php echo $_DIR; ?>images/banner/item2.jpg" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container3">
            <div class="flat-img-with-text-v2">
                        ...
                        <div class="tf-image-wrap item-1">
                            <div class="img-style hover-img-wrap">
                                <img
                                        alt=""
                                        class="lazyload"
                                        data-src="<?php echo $_DIR; ?>images/banner/img-w-text-sm1.jpg"
                                        src="<?php echo $_DIR; ?>images/banner/img-w-text-sm1.jpg"
                                />
                            </div>
                            <div class="tag-item ani5">
                                <i class="icon icon-check-circle"></i>
                                <span>تخصص اثبات شده</span>
                            </div>
                        </div>
                        <div class="tf-image-wrap item-2">
                            <div class="img-style hover-img-wrap">
                                <img
                                        alt=""
                                        class="lazyload"
                                        data-src="<?php echo $_DIR; ?>images/banner/img-w-text2.jpg"
                                        src="<?php echo $_DIR; ?>images/banner/img-w-text2.jpg"
                                />
                            </div>
                            <div class="tag-item tag-item-1 ani4">
                                <i class="icon icon-check-circle"></i>
                                <span>راه حل های سفارشی</span>
                            </div>
                            <div class="tag-item tag-item-2 ani5">
                                <i class="icon icon-check-circle"></i>
                                <span>مشارکتهای شفاف</span>
                            </div>
                        </div>
                        <div class="tf-image-wrap item-3">
                            <div class="img-style hover-img-wrap">
                                <img
                                        alt=""
                                        class="lazyload"
                                        data-src="<?php echo $_DIR; ?>images/banner/img-w-text-sm2.jpg"
                                        src="<?php echo $_DIR; ?>images/banner/img-w-text-sm2.jpg"
                                />
                            </div>
                ...
                <div class="content-right">
                    <div
                            class="box-title wow fadeInUpSmall"
                            data-wow-delay=".2s"
            ...
            <div class="wrap-banner bg-primary-new">
                <div class="box-left">
                    ...
                    <a class="tf-btn btn-view primary size-1 hover-btn-view"
                       href="<?php echo get_permalink(6126); ?>">
                        با ما در در ارتباط باشید
                        <span class="icon icon-arrow-left2"></span>
                    </a>
                </div>
                <div class="box-right">
                    <img alt="image" src="<?php echo $_DIR; ?>images/banner/banner.png" />
                </div>
            </div>
        </div>
    </section>
