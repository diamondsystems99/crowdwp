...
$(document).ready(function () {
  ...
  var moneyFormat = wNumb({
    decimals: 0, // تعداد اعشار
    thousand: ",", // جداکننده هزارگان
    prefix: "تومان ", // پیشوند واحد پول
  });

  // ایجاد نوار لغزنده
  noUiSlider.create(rangeSlider, {
    start: [100, 650000], // مقادیر شروع
    step: 1, // اندازه هر گام
    range: {
      min: [100], // حداقل مقدار
      max: [650000], // حداکثر مقدار
    },
    format: moneyFormat, // قالب‌بندی اعداد
    connect: true, // اتصال دو دسته
  });

  // تنظیم مقادیر حداقل و حداکثر و به‌روزرسانی مقادیر فرم‌های مخفی
  rangeSlider.noUiSlider.on("update", function (values, handle) {
    document.getElementById("slider-range-value1").innerHTML = values[0]; // مقدار حداقل
    document.getElementById("slider-range-value2").innerHTML = values[1]; // مقدار حداکثر

    document.getElementsByName("min-value").value = moneyFormat.from(values[0]); // مقدار حداقل برای فرم
    document.getElementsByName("max-value").value = moneyFormat.from(values[1]); // مقدار حداکثر برای فرم
  });
});
...
$(document).ready(function () {
  ...
  var moneyFormat = wNumb({
    decimals: 0, // تعداد اعشار
    thousand: ",", // جداکننده هزارگان
    postfix: " متر مربع", // پسوند واحد
  });

  // ایجاد نوار لغزنده
  noUiSlider.create(rangeSlider, {
    start: [500, 1500], // مقادیر شروع
    step: 1, // اندازه هر گام
    range: {
      min: [20], // حداقل مقدار
      max: [2000], // حداکثر مقدار
    },
    format: moneyFormat, // قالب‌بندی اعداد
    connect: true, // اتصال دو دسته
  });
  ...
  // تنظیم مقادیر حداقل و حداکثر و به‌روزرسانی مقادیر فرم‌های مخفی
  rangeSlider.noUiSlider.on("update", function (values, handle) {
    document.getElementById("slider-range-value01").innerHTML = values[0]; // مقدار حداقل
    document.getElementById("slider-range-value02").innerHTML = values[1]; // مقدار حداکثر

    document.getElementsByName("min-value2").value = moneyFormat.from(
      values[0]
    ); // مقدار حداقل برای فرم
    document.getElementsByName("max-value2").value = moneyFormat.from(
      values[1]
    ); // مقدار حداکثر برای فرم
  });
});
...
$(document).ready(function () {
  if ($("#slider-range3").length > 0) {
    ...
    // تنظیم مقادیر حداقل و حداکثر و به‌روزرسانی مقادیر فرم‌های مخفی
    rangeSlider.noUiSlider.on("update", function (values, handle) {
      document.getElementById("slider-range-value3").innerHTML = values[0]; // مقدار حداقل
      document.getElementById("slider-range-value4").innerHTML = values[1]; // مقدار حداکثر
...
$(document).ready(function () {
  if ($("#slider-range4").length > 0) {
    ...
    var moneyFormat = wNumb({
      decimals: 0,
      thousand: ",",
      postfix: " متر مربع", // پسوند برای نمایش واحد
    });

    // ایجاد نوار لغزنده با استفاده از noUiSlider
    noUiSlider.create(rangeSlider, {
      start: [500, 1500], // مقادیر شروع
      step: 1, // مقدار هر گام
      range: {
    ...
    // تنظیم مقادیر حداقل و حداکثر و به‌روزرسانی مقادیر فرم‌های مخفی
    rangeSlider.noUiSlider.on("update", function (values, handle) {
      document.getElementById("slider-range-value03").innerHTML = values[0]; // مقدار حداقل
      document.getElementById("slider-range-value04").innerHTML = values[1]; // مقدار حداکثر
