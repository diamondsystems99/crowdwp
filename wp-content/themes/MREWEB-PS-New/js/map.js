  ...
  function mainMap() {
    ...
    function locationData(
      ...
      return (
        ...
        "</a></div>" +
        '<ul class="list-info">' +
        '<li><span class="icon icon-bed"></span><span class="text-variant-1">تخت ها</span><span class="fw-6">4</span></li>' +
        '<li><span class="icon icon-bath"></span><span class="text-variant-1">حمام:</span><span class="fw-6">2</span></li>' +
        '<li><span class="icon icon-sqft"></span><span class="text-variant-1">متر مربع:</span><span class="fw-6">1150</span></li>' +
        "</ul>" +
    ...
    var locations = [
      [
        locationData(
          ...
          "145 خیابان بروکلین ، کالیفرنیا ، نیویورک",
